...
class QuarkArch(Architecture):
    ...
    semantic_flag_classes = [
        'cmp.lt',  'cmp.le',  'cmp.ge',  'cmp.gt',  'cmp.eq',  'cmp.ne',  'cmp.z',  'cmp.nz',
        'icmp.lt', 'icmp.le', 'icmp.ge', 'icmp.gt', 'icmp.eq', 'icmp.ne', 'icmp.z', 'icmp.nz',
    ]
    ...
    flag_conditions_for_semantic_flag_group = {
        'cc0': {
            ...
            'cmp.eq': LowLevelILFlagCondition.LLFC_E,
            'cmp.ne': LowLevelILFlagCondition.LLFC_NE,
            ...
            'icmp.eq': LowLevelILFlagCondition.LLFC_E,
            'icmp.ne': LowLevelILFlagCondition.LLFC_NE,
        },
        'cc1': {
            'cmp.lt': LowLevelILFlagCondition.LLFC_ULT,
            'cmp.le': LowLevelILFlagCondition.LLFC_ULE,
    ...
    semantic_class_for_flag_write_type = {
        'cc0.cmp.lt':  'cmp.lt',  'cc0.cmp.le':  'cmp.le',  'cc0.cmp.ge':  'cmp.ge',  'cc0.cmp.gt':  'cmp.gt',  'cc0.cmp.eq':  'cmp.eq',  'cc0.cmp.ne':  'cmp.ne',  'cc0.cmp.z':  'cmp.z',  'cc0.cmp.nz':  'cmp.nz',
        'cc0.icmp.lt': 'icmp.lt', 'cc0.icmp.le': 'icmp.le', 'cc0.icmp.ge': 'icmp.ge', 'cc0.icmp.gt': 'icmp.gt', 'cc0.icmp.eq': 'icmp.eq', 'cc0.icmp.ne': 'icmp.ne', 'cc0.icmp.z': 'icmp.z', 'cc0.icmp.nz': 'icmp.nz',
        'cc1.cmp.lt':  'cmp.lt',  'cc1.cmp.le':  'cmp.le',  'cc1.cmp.ge':  'cmp.ge',  'cc1.cmp.gt':  'cmp.gt',  'cc1.cmp.eq':  'cmp.eq',  'cc1.cmp.ne':  'cmp.ne',  'cc1.cmp.z':  'cmp.z',  'cc1.cmp.nz':  'cmp.nz',
        'cc1.icmp.lt': 'icmp.lt', 'cc1.icmp.le': 'icmp.le', 'cc1.icmp.ge': 'icmp.ge', 'cc1.icmp.gt': 'icmp.gt', 'cc1.icmp.eq': 'icmp.eq', 'cc1.icmp.ne': 'icmp.ne', 'cc1.icmp.z': 'icmp.z', 'cc1.icmp.nz': 'icmp.nz',
        'cc2.cmp.lt':  'cmp.lt',  'cc2.cmp.le':  'cmp.le',  'cc2.cmp.ge':  'cmp.ge',  'cc2.cmp.gt':  'cmp.gt',  'cc2.cmp.eq':  'cmp.eq',  'cc2.cmp.ne':  'cmp.ne',  'cc2.cmp.z':  'cmp.z',  'cc2.cmp.nz':  'cmp.nz',
        'cc2.icmp.lt': 'icmp.lt', 'cc2.icmp.le': 'icmp.le', 'cc2.icmp.ge': 'icmp.ge', 'cc2.icmp.gt': 'icmp.gt', 'cc2.icmp.eq': 'icmp.eq', 'cc2.icmp.ne': 'icmp.ne', 'cc2.icmp.z': 'icmp.z', 'cc2.icmp.nz': 'icmp.nz',
        'cc3.cmp.lt':  'cmp.lt',  'cc3.cmp.le':  'cmp.le',  'cc3.cmp.ge':  'cmp.ge',  'cc3.cmp.gt':  'cmp.gt',  'cc3.cmp.eq':  'cmp.eq',  'cc3.cmp.ne':  'cmp.ne',  'cc3.cmp.z':  'cmp.z',  'cc3.cmp.nz':  'cmp.nz',
        'cc3.icmp.lt': 'icmp.lt', 'cc3.icmp.le': 'icmp.le', 'cc3.icmp.ge': 'icmp.ge', 'cc3.icmp.gt': 'icmp.gt', 'cc3.icmp.eq': 'icmp.eq', 'cc3.icmp.ne': 'icmp.ne', 'cc3.icmp.z': 'icmp.z', 'cc3.icmp.nz': 'icmp.nz',
    }
    flag_write_types = {
        'none',
